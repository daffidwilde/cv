...
\cventry{2018--present}{Assessment Assistant}{Cardiff University}{Cardiff}{}{%
    \begin{itemize}
        \item \textbf{Computational Methods:} I have acted as part of the
            ...
            assessment is comprised of a two-day hackathon involving several
            dozen students and my role has been to gauge, then rank, their
            abilities to work in teams to develop a piece of software for a
...
\subsection{Bursaries and Awards}
...
\begin{cvcolumns}
    \cvcolumn{Academic}{%
        \begin{itemize}
            \item[] Dr.\ Vincent Knight
            \item[] Senior Lecturer
            \item[] School of Mathematics, Cardiff University
    ...
    \cvcolumn{Personal}{%
        \begin{itemize}
            \item[] Alex Beeston
            \item[] Manager and Owner
            \item[] The High Cross, Tottenham
            \item[] \texttt{alexbeeston1988@gmail.com}
        \end{itemize}
    }
\end{cvcolumns}
